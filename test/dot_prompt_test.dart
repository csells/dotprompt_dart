...
void main() {
  group('DotPrompt', () {
    ...
    test('loads prompt metadata and template', () {
      ...
      expect(dotPrompt.metadata['description'], 'A simple greeting prompt');
      expect(dotPrompt.metadata['model'], 'gemini-2.0-pro');
      expect(dotPrompt.metadata['temperature'], 0.7);
      expect(dotPrompt.inputSchema, isNotNull);
      expect(dotPrompt.outputSchema, isNotNull);
